...
parser.add_argument("--return-interaction-sequence", action="store_true", default=False,
                    help="whether encoder return sequence of interaction")
parser.add_argument("--receive-sequence", action="store_true", default=False,
                    help="whether decoder return sequence of interaction")
...
encoder = RNNEncoder(args.dims, args.node_embedding, args.edge_embedding, args.node_hidden, args.edge_hidden,
                     args.rnn_type, args.return_interaction_sequence)
decoder = RNNDecoder(args.dims, args.node_embedding, args.node_hidden, args.rnn_type,
...
def train(epoch, best_val_loss):
    ...
    for batch_idx, (data, relations) in enumerate(valid_loader):
        ...
        with torch.no_grad():
            A, h_i = encoder(data, rel_rec, rel_send)
            output = output = decoder(data, A ,h_i, use_steps = args.use_steps)
